...
/**
 * Represents the response with the result of a transaction state update operation
...
public class UpdateStateResponseSoapWrapper extends FDBaseResponseSoapWrapper {
