 ...
 * The lists in the fraud detection system; are used to save data bases of reliable/good data(also named white lists)
...
public class ListMatch {
	...
	/** Indicates if some transaction field matchs with some value contained in a list. */
	@Element(name = "coincide", required = false)
	private boolean match;

	/** The name of the transaction field matching with some value contained in a list. */
