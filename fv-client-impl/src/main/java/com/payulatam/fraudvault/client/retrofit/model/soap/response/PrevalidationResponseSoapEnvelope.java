...
/**
 * Encapsulates a soap message envelope of the fraudvault prevalidation response.
 * 
...
public class PrevalidationResponseSoapEnvelope {

	@Element(name = "preValidarResponse")
	@Path("Body")
