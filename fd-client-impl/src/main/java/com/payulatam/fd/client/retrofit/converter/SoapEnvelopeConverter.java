...
import com.payulatam.fd.client.retrofit.model.soap.request.PrevalidationBodyData;
...
/**
 * Utility class for convert the transaction data to be sent to fraud detection service
 * in objects of the soap message envelope model.
 * 
