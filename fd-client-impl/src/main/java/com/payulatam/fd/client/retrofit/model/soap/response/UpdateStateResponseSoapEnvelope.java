...
/**
 * Encapsulates a soap message envelope for the response of the transaction state update.
 * 
...
public class UpdateStateResponseSoapEnvelope {

	@Element(name = "actualizarEstadoResponse")
	@Path("Body")
	...
	private ResponseBodyData updateStateResponseBodyData;
